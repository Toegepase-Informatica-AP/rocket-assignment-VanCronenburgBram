...
namespace UnityStandardAssets.Vehicles.Rocket
{

    public class Rocket : MonoBehaviour
    {
        [SerializeField] private float m_MovePower = 5; // The force added to the rocket to move it.
        [SerializeField] private bool m_UseTorque = true; // Whether or not to use torque to move the rocket.
        [SerializeField] private float m_MaxAngularVelocity = 25; // The maximum velocity the rocket can rotate at.
        [SerializeField] private float m_JumpPower = 2; // The force added to the rocket when it jumps.
        ...
        {
            // If using torque to rotate the rocket...
            if (m_UseTorque)
            {
